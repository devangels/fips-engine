...
vars = {
  ...
  'skia_revision': '7854da39b3c1cfabb6254d57a66616ad7bba9006',
  ...
  'dart_sse_tag': '5da8fedcdc56f306933d202e2d204753eecefd36',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/shelf':
   Var('dart_git') + '/shelf.git@e9294125f0c1fc2049c958577cd586ca2395168f',
  ...
  'src/third_party/dart/third_party/pkg/shelf_web_socket':
   Var('dart_git') + '/shelf_web_socket.git@aa312d3cdeef96fb64bc3e602bc354a05a995624',
  ...
  'src/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@2cd8a4e774439447b01f9d381da020319a9808d8',
     ...
     'packages': [
       {
        ...
        'version': 'inepr5WS8HfOthFFd88N_Oi5mabD9HUzteT5a8FSe3QC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'GsRYVri0--HMj1u6xCZ14zIoYP4OhkxD6DSWvyYvQgsC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
